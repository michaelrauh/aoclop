...
(check-equal?
 (parse-to-datum
  (apply-tokenizer-maker make-tokenizer "find: noun in 0->100 verb in 0->100 end satisfying: foreign tape(noun, verb) in file_2.2_tape.rkt = 19690720 end return: noun * 100 + verb end")) '(search-program
    (find-block
     (assignment-sequence
